				...
				<div className="flex items-center justify-between relative">
					<div className="px-4">
						{location === "/" ? (
							<a
								href="#home"
								className="font-libre text-white lg:text-3xl md:text-3xl sm:text-xl"
							>
						...
						>
							<div className="block lg:flex lg:justify-center lg:items-center">
								<ul className="block lg:flex lg:justify-center lg:items-center space-y-3 lg:space-y-0">
									<li className="group lg:flex">
										{location === "/" ? (
											<a
												href="#home"
												className="text-base py-2 mx-6 font-quicksand font-base group-hover:text-primary"
											>
												Home
											</a>
										) : (
								...
								<form
									...
									className="pt-6 px-6 lg:pt-0 lg:px-0 flex"
									id="form-search"
								>
									<input
										type="text"
										onChange={searchChange}
										className="w-full text-base border border-primary border-opacity-50 bg-secblack/20 rounded-lg text-white py-1 px-2 focus:outline-none focus:ring-0"
